...
[month or season, if you want to date the scene] One of our senior developers was handed a well-formed plan through our new workflow, the set of commands and agents we built around our coding agent this year to scope tickets, plan delivery and hand work back for review. Some way into implementation, we started asking why it was taking so long to see results. We would have expected to see something within a few days, and after more than a week we were still at the "it's coming together" stage.
...
[how the restart went: time to first visible result against the by-hand week, and whether it shipped through the phase stops]
...
[one CookiesHQ hand-over where an assumed decision came back different, if one comes back to you; otherwise cut this line]
...
I can't say anything about his experience, really. I don't work there. What I can say is that when Business Insider followed up with him, his own diagnosis pointed at management measuring the team on sprint velocity, PR count and features shipped, without giving engineers time to review the generated code or understand the architecture underneath it.
...
[one named ticket that went scope, dev-plan, phases, accepted, if you want one here]
...
We're soon getting two new developers on the team, so we will see what teaching this from day one looks like. [start date, if you want one] In the past it was easy: you would give them some small, light tickets you knew would touch a broad surface of the app, let them loose and let them discover. I have no idea what that looks like today.
