...
* **Be humble**: Yes, you have done a bootcamp, and some may want you to think that when you leave them, you're almost a mid-dev after three months. This is not true. You'll have a ton to learn that is not taught in bootcamp. So understand what you're missing, where the holes are, and state them clearly.
